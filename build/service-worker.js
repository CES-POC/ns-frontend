...
!(function () {
  ...
  !(function () {
    ...
    function _() {
      ...
      function h(e, t, r, a) {
        var i = t && t.prototype instanceof p ? t : p,
          ...
          c = new C(a || []);
        return n(s, "_invoke", { value: k(e, r, c) }), s;
      }
      function f(e, t, r) {
        try {
      ...
      return (
        ...
        (v.displayName = o(d, c, "GeneratorFunction")),
        ...
        (e.mark = function (e) {
          return (
            Object.setPrototypeOf
              ...
              : ((e.__proto__ = d), o(e, c, "GeneratorFunction")),
    ...
    function Z(e) {
      return e !== IDBDatabase.prototype.transaction ||
        ...
        : function (t) {
            ...
            return Y.set(i, t.sort ? t.sort() : [t]), te(i);
          };
    }
    function ee(e) {
    ...
    function te(e) {
      ...
      var t = ee(e);
      return t !== e && (Q.set(e, t), J.set(t, e)), t;
    }
    var re = function (e) {
      return J.get(e);
    };
      ...
      return (
        a &&
          c.addEventListener("upgradeneeded", function (e) {
            a(te(c.result), e.oldVersion, e.newVersion, te(c.transaction), e);
          }),
        n &&
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 3:
                        if (
                          ...
                          j((o = t._getCacheExpiration(i)).expireEntries()),
              ...
              value: (function () {
                var t = E(
                  _().mark(function t(r, n) {
                    var a, i, s, c, o, u, h, f, l, p, v, y, g;
                    return _().wrap(
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              return (a = be(r)), (t.next = 3), I(0);
                            case 3:
        ...
        function e() {
          ...
          a(this, e),
            ...
            (this._strategy = new we({
              cacheName: w(r),
              plugins: [].concat(ve(i), [new ge({ precacheController: this })]),
              fallbackToNetwork: c,
            })),
    ...
    var Ee,
      ...
      Pe = function () {
        return (
          Ee || ((Ee = new Ne()).addFetchListener(), Ee.addCacheListener()), Ee
        );
      };
    function Te(e, t, r) {
      var n;
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 4:
                              return (a = je(r, n)), (t.next = 7), a.href;
                            case 7:
    ...
    var De,
      ...
      Ke = n(function e(t) {
        ...
        a(this, e),
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (
                          ((n = t.response),
                          !r._cacheableResponse.isResponseCacheable(n))
                        ) {
                          e.next = 3;
                          break;
                        }
          ...
          (this._cacheableResponse = new Me(t));
      });
    console.log(location),
      ...
      (function (e) {
        ...
        { revision: "eb7a36ab35361f93e7a2a825bbe5a91c", url: "/index.html" },
        { revision: null, url: "/static/css/main.9d2066e5.css" },
        { revision: null, url: "/static/js/13.c7c8dced.chunk.js" },
        { revision: null, url: "/static/js/703.f1e8e563.chunk.js" },
        { revision: null, url: "/static/js/787.cdc55af2.chunk.js" },
        { revision: null, url: "/static/js/main.a2ff42dd.js" },
        {
          revision: null,
          url: "/static/media/AlegreyaSans-Bold.643f914d33e580c52b47.ttf",
        },
        {
          revision: null,
          url: "/static/media/AlegreyaSans-Light.82019eb4d418cfbf15d5.ttf",
        },
        {
          revision: null,
          url: "/static/media/AlegreyaSans-Regular.0661bf20265a8642f0a0.ttf",
        },
        {
          revision: null,
          url: "/static/media/AveriaLibre-Bold.27ef9a71bbfdafbe3b89.ttf",
        },
        {
          revision: null,
          url: "/static/media/AveriaLibre-Light.0dfdac32ed09bcbf6eb4.ttf",
        },
        {
          revision: null,
          url: "/static/media/AveriaLibre-Regular.2c1c98d1cd669012479f.ttf",
        },
        {
          revision: null,
          url: "/static/media/RobotoCondensed-Bold.c2aa0091dafe9666f9e3.ttf",
        },
        {
          revision: null,
          url: "/static/media/RobotoCondensed-Light.47aab7f72715e676833f.ttf",
        },
        {
          revision: null,
          url: "/static/media/RobotoCondensed-Regular.67977954c77ecc1cd90f.ttf",
        },
        {
          revision: null,
          url: "/static/media/toolbar-icons-dark.f2eb1d36bbb96079af83.woff",
        },
        {
          revision: null,
          url: "/static/media/toolbar-icons-modern.7282c7ca12cbfab871c3.png",
        },
      ]),
      (function (e) {
        var t = Re();
    ...
    Te(function (e) {
    ...
    }, ((We = "/index.html"), Re().createHandlerBoundToURL(We))),
      Te(function (e) {
        var t = e.url;
        return (
          t.origin === self.location.origin &&
          t.pathname.endsWith(".png", ".jpg")
        );
      }, new Ie({
        cacheName: "images",
      ...
      }, new Ie({ cacheName: "google-fonts-stylesheets" })),
      Te(function (e) {
        return "https://fonts.googleapis.com" === e.url.origin;
      }, new Ue({
        cacheName: "google-fonts-webfonts",
        plugins: [
          new Ke({ statuses: [0, 200] }),
          new pe({ maxAgeSeconds: 31536e3, maxEntries: 30 }),
        ],
      }));
    var Fe = new RegExp(
    ...
    Te(function (e) {
      ...
      Te(function (e) {
        var t = e.url;
        return (
          "https://neobck.azurewebsites.net" === t.origin &&
          t.pathname.startsWith("/api/paper")
        );
      }, new Ie({
        cacheName: "api-paper",
        plugins: [new Ke({ statuses: [0, 200] }), new pe({ maxEntries: 1e3 })],
      })),
      Te(function (e) {
        var t = e.url;
        return (
      ...
      Te(function (e) {
        ...
        return (
          "https://neobck.azurewebsites.net" === t.origin &&
          t.pathname.startsWith("/api/shapes")
        );
      }, new Ie({
        cacheName: "api-paper",
        plugins: [new Ke({ statuses: [0, 200] }), new pe({ maxEntries: 1e3 })],
      ...
      Te(function (e) {
        ...
        plugins: [
          new Ke({ statuses: [0, 200] }),
          new pe({ maxEntries: 1e3, maxAgeSeconds: 2592e3 }),
        ],
      }));
  })();
})();
